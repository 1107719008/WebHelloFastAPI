...
class DbUser(Base):
    ...
    likes = relationship('DbLike', back_populates='liked_user')
    comments = relationship('DbComment', back_populates='commemted_user')
...
class DbLike(Base):
    ...
    liked_article = relationship('DbHomework', back_populates='article_liked')
    liked_user = relationship('DbUser', back_populates='likes')
...
class DbComment(Base):
    ...
    commemted_user = relationship('DbUser', back_populates='comments')
