...
class DbHomework(Base):
    ...
    article_liked = relationship('DbLike', back_populates ='liked_post')
    article_commented = relationship('DbComment', back_populates ='commented_post')
...
class DbLike(Base):
    ...
    liked_post = relationship('DbHomework', back_populates='article_liked')
...
class DbComment(Base):
    ...
    commented_post = relationship('DbHomework', back_populates='article_commented')
