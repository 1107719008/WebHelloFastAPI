...
from router.schemas import LikeRequestSchema, LikeResponseSchema,LikeResponseWithInfoSchema
...
@router.get('/id/{like_id}', response_model=LikeResponseWithInfoSchema)
